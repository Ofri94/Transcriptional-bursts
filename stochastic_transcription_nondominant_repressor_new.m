...
for act=A
    ...
    for itr2=1:sample_size
        ...
        while t(end)<360000
            ...
            current_Moff=rate_Moff/(n+1);%M appropriate to the occupancy. dependant on total occupancy
...
%         
    ...
    % er.Color = [0 0 0];
    % er.LineStyle = 'none';
       save(['Stochastich T, non-dominant rep new, A conc. = ' num2str(act) ' , R coc. = ' num2str(rep)])
end
end
% figure;
% subplot(1,2,1)
